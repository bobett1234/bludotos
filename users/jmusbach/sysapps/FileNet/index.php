...
var goto2 = new XMLHttpRequest();
	...
	if(thisis[actT.x].cdiv == thisis[actT.x].innerdivs && thisis[actT.x].listview != true) {
		...
		for(var i=0; i < thisis[actT.x].response.dirs.length; i++)
		{
			...
			newtr.innerHTML = '<td style="text-align:left;" class="name"><div><img alt="" src="<? echo $Ifolder; ?>" /><a onclick="thisis[actT.x].goto((thisis[actT.x].response.location+\'/\'+this.innerText));">'+thisis[actT.x].response.dirs[i]+'</a></div></td><td style="text-align:left;" class="type">Size</td>';
		...
		for(var i=0; i < thisis[actT.x].response.files.length; i++)
		{
			...
			if(temp == 'png' || temp == 'jpg' || temp == 'jpeg' || temp == 'gif'){
				var type = 'image';
			newtr.innerHTML = '<td style="text-align:left;" class="name"><div><img alt="" src="<? echo $Iimage; ?>" /><a onclick="thisis[actT.x].goto((this.innerText+thisis[actT.x].response.location));">'+thisis[actT.x].response.files[i]+'</a></div></td><td style="text-align:left;" class="type">'+type+'</td>';
			} else {
				var type = 'undefined';
			newtr.innerHTML = '<td style="text-align:left;" class="name"><div><img alt="" src="<? echo $Ifile; ?>" /><a onclick="thisis[actT.x].goto((this.innerText+thisis[actT.x].response.location));">'+thisis[actT.x].response.files[i]+'</a></div></td><td style="text-align:left;" class="type">'+type+'</td>';
			}
			window.actT.children[1].children[2].children[thisis[actT.x].cdivs].children[0].children[0].appendChild(newtr);
		};
		}
		...
		for(var i=0; i < thisis[actT.x].response.files.length; i++)
		{
			...
			var newtr = document.createElement('tr');
			newtr.innerHTML = '<td style="text-align:left;" class="name"><div><img alt="" src="<? echo $Iapp; ?>" /><a onclick="thisis[actT.x].openapp((this.innerText));">'+thisis[actT.x].response.files[i]+'</a></div></td><td style="text-align:left;" class="type">'+type+'</td>';
			window.actT.children[1].children[2].children[thisis[actT.x].cdivs].children[0].children[0].appendChild(newtr);
		};
		}
        }
...
thisis[actT.x].gotoit=gotoit;
	...
	if (goto2.readyState==4) {
		...
		{
			var newtr = document.createElement('tr');
			newtr.innerHTML = '<td style="text-align:left;" class="name"><div><img alt="" src="<? echo $Ifolder; ?>" /><a onclick="thisis[actT.x].click(this.parentNode.parentNode);thisis[actT.x].goto((thisis[actT.x].response.location+\'/\'+this.innerText));">'+thisis[actT.x].response.dirs[i]+'</a></div></td><td style="text-align:left;" class="type">Size</td>';
			window.actT.children[1].children[2].children[thisis[actT.x].cdivs].children[0].children[0].appendChild(newtr);
		};
		}
		if(thisis[actT.x].response.files){
		for(var i=0; i < thisis[actT.x].response.files.length; i++)
		{
			...
			newtr.innerHTML = '<td style="text-align:left;" class="name"><div><img alt="" src="<? echo $Iimage; ?>" /><a onclick="void(0);">'+thisis[actT.x].response.files[i]+'</a></div></td><td style="text-align:left;" class="type">'+type+'</td>';
				...
				var type = 'undefined';
                        newtr.innerHTML = '<td style="text-align:left;" class="name"><div><img alt="" src="<? echo $Ifile; ?>" /><a onclick="thisis[actT.x].goto(this.innerText);">'+response.files[i]+'</a></div></td><td class="type" style="text-align:left;">Size</td>';
                        };
			window.actT.children[1].children[2].children[thisis[actT.x].cdivs].children[0].children[0].appendChild(newtr);
		};
		}
...
node.onmouseup = function(){
     document.onmousemove = null;
		...
		{
			var newtr = document.createElement('tr');
			newtr.innerHTML = '<td style="text-align:left;" class="name"><div><img alt="" src="<? echo $Ifolder; ?>" /><a onclick="thisis[actT.x].click(this.parentNode.parentNode);thisis[actT.x].goto(this.innerText);">'+response.dirs[i]+'</a></div></td><td class="type" style="text-align:left;">Size</td>';
		...
		for(var i=0; i < response.files.length; i++)
		{
			...
			newtr.innerHTML = '<td style="text-align:left;" class="name"><div><img alt="" src="<? echo $Ifile; ?>" /><a onclick="thisis[actT.x].goto(this.innerText);">'+response.files[i]+'</a></div></td><td class="type" style="text-align:left;">Size</td>';
                        ...
                        newtr.innerHTML = '<td style="text-align:left;" class="name"><div><img alt="" src="<? echo $Iimage; ?>" /><a onclick="thisis[actT.x].goto(this.innerText);">'+response.files[i]+'</a></div></td><td class="type" style="text-align:left;">Size</td>';
                        };
			window.actT.children[1].children[2].children[0].children[0].children[0].appendChild(newtr);
		};
