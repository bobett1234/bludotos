...
var div = document.getElementById('Themes').children[0].children[0];
	...
	win.onreadystatechange = function() {
		if (win.readyState==4) {
                ...
                //alert(temp.dirs);
                document.getElementById('Preferences').children[1].children[0].children[4].children[0].children[0].children[0].innerHTML+='<ul></ul>';
                for(var i=0; i < temp.dirs.length; i++) {
                document.getElementById('Preferences').children[1].children[0].children[4].children[0].children[0].children[0].children[1].innerHTML+='<li style="display:block;"><a onclick="window.themeup(\'windows\', \''+temp.dirs[i]+'\');">'+temp.dirs[i]+'</a></li>';
if(core.windowtheme == temp.dirs[i]) {
document.getElementById('Preferences').children[1].children[0].children[4].children[0].children[0].children[0].children[1].children[i].style.cssText+="background: -webkit-linear-gradient(top, #b5bdc8 0%,#828c95 52%,#676868 100%);margin: 5px 0px 5px 0px;";
};
                };
document.getElementById('Preferences').children[1].children[0].children[4].children[0].children[0].children[0].children[1].style.cssText ="height: auto;position: absolute;left: 5px;right: 5px;bottom: 5px;top: 20px;list-style: none;text-align: center;margin: 0px;padding: 0px;background: white;box-shadow: inset 0px 0px 10px 5px grey;border-radius: 5px;"
                };
        };
win.send();
var div = document.getElementById('Themes').children[0].children[0];
	...
	task.onreadystatechange = function() {
		if (task.readyState==4) {
                ...
                //alert(temp.dirs);
                document.getElementById('Preferences').children[1].children[0].children[4].children[0].children[0].children[1].innerHTML+='<ul></ul>';
                for(var i=0; i < temp.dirs.length; i++) {
                document.getElementById('Preferences').children[1].children[0].children[4].children[0].children[0].children[1].children[1].innerHTML+='<li  style="display:block;"><a onclick="window.themeup(\'taskbar\', \''+temp.dirs[i]+'\');">'+temp.dirs[i]+'</a></li>';
if(core.taskbartheme == temp.dirs[i]) {
document.getElementById('Preferences').children[1].children[0].children[4].children[0].children[0].children[1].children[1].children[i].style.cssText+="background: -webkit-linear-gradient(top, #b5bdc8 0%,#828c95 52%,#676868 100%);margin: 5px 0px 5px 0px;";
};
                };
document.getElementById('Preferences').children[1].children[0].children[4].children[0].children[0].children[1].children[1].style.cssText ="height: auto;position: absolute;left: 5px;right: 5px;bottom: 5px;top: 20px;list-style: none;text-align: center;margin: 0px;padding: 0px;background: white;box-shadow: inset 0px 0px 10px 5px grey;border-radius: 5px;"
                };
        };
task.send();
var div = document.getElementById('Themes').children[0].children[0];
	...
	dock.onreadystatechange = function() {
		if (dock.readyState==4) {
                ...
                //alert(temp.dirs);
                document.getElementById('Preferences').children[1].children[0].children[4].children[0].children[0].children[2].innerHTML+='<ul></ul>';
                for(var i=0; i < temp.dirs.length; i++) {
                document.getElementById('Preferences').children[1].children[0].children[4].children[0].children[0].children[2].children[1].innerHTML+='<li style="display:block;"><a onclick="window.themeup(\'dock\', \''+temp.dirs[i]+'\');">'+temp.dirs[i]+'</a></li>';
if(core.docktheme == temp.dirs[i]) {
document.getElementById('Preferences').children[1].children[0].children[4].children[0].children[0].children[2].children[1].children[i].style.cssText+="background: -webkit-linear-gradient(top, #b5bdc8 0%,#828c95 52%,#676868 100%);margin: 5px 0px 5px 0px;";
};
                };
document.getElementById('Preferences').children[1].children[0].children[4].children[0].children[0].children[2].children[1].style.cssText ="height: auto;position: absolute;left: 5px;right: 5px;bottom: 5px;top: 20px;list-style: none;text-align: center;margin: 0px;padding: 0px;background: white;box-shadow: inset 0px 0px 10px 5px grey;border-radius: 5px;"
                };
        };
dock.send();
};
