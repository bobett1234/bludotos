...
thisis[actT.x].gotoit=gotoit;
	...
	if (goto2.readyState==4) {
        ...
        window.actT.children[1].children[2].children[thisis[actT.x].cdivs].children[1].innerText = thisis[actT.x].response.location;
        window.actT.children[1].children[2].children[thisis[actT.x].cdivs].removeChild(window.actT.children[1].children[2].children[thisis[actT.x].cdivs].lastChild);
		MainTools.scrollV(thisis[actT.x].children[1].children[2].children[thisis[actT.x].cdivs], thisis[actT.x], thisis[actT.x].children[1].children[2].children[thisis[actT.x].cdivs].children[0].children[0], -200);				
	};
	};
goto2.send(sendit);
};
...
<div id="0" style="position:relative;width:150px;height:100%;float:left;box-shadow: -3px 0px 3px gray;border-left: 1px solid black;" onmouseover="thisis[actT.x].cdiv=parseInt(this.id);">
<table id="content" align="left" style="position:relative;top:20px;left:0px;width:100%;height:100%;">
<tbody  style="position:absolute;overflow:hidden;height:100%;width:100%;">
<tr>
