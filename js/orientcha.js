...
function updateOrientation()
{
	...
	switch(orientation)
	{
		...
		case 0:
				...
				document.getElementById('menubar').style.top = 10+'px';
				
				/* Add a descriptive message on "Handling iPhone or iPod touch Orientation Events"  */
				document.getElementById("currentOrientation").innerHTML="Now in portrait orientation (Home button on the bottom)."; document.getElementById('thedesktop').style.width = 100+'px';
				break;	
